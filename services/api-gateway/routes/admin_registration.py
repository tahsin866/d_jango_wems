"""
Admin Registration Routes for API Gateway
"""
...
router = APIRouter(prefix="/api/admin/registration", tags=["admin-registration"])
...
async def admin_registration_general(request: Request, path: str):
    """Proxy general admin registration requests"""
    body = await request.body()
