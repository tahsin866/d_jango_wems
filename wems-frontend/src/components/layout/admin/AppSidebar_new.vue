<template>
  <aside style="font-family: 'SolaimanLipi', sans-serif;" :class="[
    ...
    <!-- Navigation -->
    <div
      class="flex-1 overflow-y-auto bg-[#18222e] custom-scrollbar">
      <nav class="px-0 py-2">
        <div class="space-y-1">
...
// Add setHovered function to avoid error
const setHovered = (hovered: boolean) => {
  // This might need to be implemented based on your useSidebar composable
