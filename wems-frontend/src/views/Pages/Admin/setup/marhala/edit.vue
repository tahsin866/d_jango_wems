      ...
      <div class="bg-white rounded-lg shadow-lg border border-[#d2d6de]">
        <div class="px-8 py-7">
          ...
          <form @submit.prevent="handleSubmit" @submit.stop class="space-y-10">
            <!-- Loading State -->
            <div v-if="loadingData" class="bg-[#e9ecef] border border-[#bce8f1] rounded p-4 mb-4">
              <div class="flex items-center gap-2 text-[#3c8dbc]">
                <i class="fas fa-spinner fa-spin"></i>
                <span>ডেটা লোড করা হচ্ছে...</span>
              </div>
            </div>
            <div v-else-if="loading" class="bg-[#e9ecef] border border-[#bce8f1] rounded p-4 mb-4">
              <div class="flex items-center gap-2 text-[#3c8dbc]">
                <i class="fas fa-spinner fa-spin"></i>
            ...
            <div class="flex justify-between mt-8">
              <div class="flex gap-3">
                ...
                <button
                  ...
                  class="inline-flex items-center px-6 py-3 bg-[#e9ecef] border border-[#d2d6de] rounded font-semibold text-base text-[#222d32] hover:bg-[#f4f6f9] transition"
                >
                ...
                <button
                  ...
                  class="inline-flex items-center px-8 py-3 bg-[#dd4b39] border border-[#d2d6de] rounded font-bold text-base text-white uppercase tracking-widest shadow hover:bg-[#c23321] transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
              ...
              <button
                type="submit"
                :disabled="loading || loadingData"
                class="inline-flex items-center px-8 py-3 bg-[#3c8dbc] border border-[#d2d6de] rounded font-bold text-base text-white uppercase tracking-widest shadow hover:bg-[#367fa9] transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <i v-if="loading" class="fas fa-spinner fa-spin mr-2"></i>
                <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<!-- script section unchanged from your code -->
